"""
Django settings for abet_assessment project.
...
SECRET_KEY = 'django-insecure-1rzqs81-k*6p)+#qe4n+rjz*%+loo+$qp&de+l#nidw89!#eo('
...
ROOT_URLCONF = 'abet_assessment.urls'
...
WSGI_APPLICATION = 'abet_assessment.wsgi.application'
